...
public class BatchInsertPlugin extends BasePlugin {
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (!"com.mysql.jdbc.Driver".equalsIgnoreCase(this.getContext().getJdbcConnectionConfiguration().getDriverClass())
                ...
                && !"com.mysql.cj.jdbc.Driver".equalsIgnoreCase(this.getContext().getJdbcConnectionConfiguration().getDriverClass())) {
    ...
    public boolean clientGenerated(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        mBatchInsert.addJavaDocLine(" * 批量插入-插入全部字段");
        mBatchInsert.addJavaDocLine(" */");
        ...
        mBatchInsertSelective.addJavaDocLine(" * 批量插入-可选插入字段");
        mBatchInsertSelective.addJavaDocLine(" */");
