...
import com.github.Is0x4096.mybatis.generator.plugins.utils.hook.ISelectSelectivePluginHook;
...
public class SelectSelectivePlugin extends BasePlugin implements ISelectOneByExamplePluginHook {
    ...
    public boolean clientSelectByExampleWithoutBLOBsMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        if (!introspectedTable.hasBLOBColumns()) {
            ...
            if (!"selectByExample".equals(method.getName())) {
                method.addJavaDocLine(" * 查询数据-可选返回字段");
            } else {
                method.addJavaDocLine(" * 查询数据");
            }
            method.addJavaDocLine(" */");
    ...
    private Method replaceMethodWithSelective(Method method, String name, String firstAnnotation, IntrospectedTable introspectedTable) {
        ...
        withSelective.addJavaDocLine("/**");
        withSelective.addJavaDocLine(" * 查询数据-可选返回字段");
        withSelective.addJavaDocLine(" */");
